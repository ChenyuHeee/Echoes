...
export function showSettingsPanel(options?: { onLogout?: () => void; onClose?: () => void }): void {
  ...
  const makeBtn = (label: string, borderColor: string, color: string, onClick: () => void) => {
    ...
    btn.style.cssText = [
      ...
      'font-family:"Silkscreen",monospace', 'font-size:12px', 'padding:6px 14px', 'cursor:pointer',
    ].join(';')
    btn.onclick = onClick
    return btn
  }
  ...
  const showChangeUsername = () => {
    ...
    inp.maxLength = 20
    inp.style.cssText = 'background:#060b16;border:1px solid #2a4060;color:#c8d8f0;padding:6px 10px;font-family:"Silkscreen",monospace;font-size:13px;outline:none'
  ...
  const showChangePassword = () => {
    ...
    const mkInp = (ph: string) => {
      ...
      i.type = 'password'
      i.placeholder = ph
      i.style.cssText = 'background:#060b16;border:1px solid #2a4060;color:#c8d8f0;padding:6px 10px;font-family:"Silkscreen",monospace;font-size:13px;outline:none'
      return i
    }
...
export function showAboutPanel(): void {
  ...
  closeBtn.style.cssText = [
    ...
    'color:#4a7a9a', 'font-family:"Silkscreen",monospace', 'font-size:13px',
